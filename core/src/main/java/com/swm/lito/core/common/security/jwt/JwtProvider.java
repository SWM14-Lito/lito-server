package com.swm.lito.core.common.security.jwt;
...
import static com.swm.lito.core.common.exception.auth.AuthErrorCode.*;
...
public class JwtProvider implements InitializingBean {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new ApplicationException(EMPTY_CLAIM);
        }
