...
=== U003
include::{snippets}/user-controller-test/update_user_fail_not_invalid/http-request.adoc[]
include::{snippets}/user-controller-test/update_user_fail_not_invalid/http-response.adoc[]
