...
public class ProblemPageResponseDto {
    ...
    public static List<ProblemPageResponseDto> from(List<ProblemPageQueryDslResponseDto> problemPageQueryDslResponseDtos){
        return problemPageQueryDslResponseDtos.stream()
